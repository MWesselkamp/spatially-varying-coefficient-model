...
occurance_predictions <- function(dat = DougScaled, predictions = allPreds){
  ...
  p1 = ggplot() + 
    ...
    geom_point(data=dat, aes(x=Long, y=Lat, col=predictions), size = 0.5)  + 
    ...
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
          ...
          legend.title = element_text(size=16, face="bold"),legend.text = element_text(size=14), legend.key.size = unit(0.8, units = "cm"), legend.key = element_blank()) 
...
occurances <- function(dat= DougScaled){
  ...
  p2 = ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=factor(PRES, levels = c(1,0))), size = 0.5) + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
          panel.border = element_rect(colour="grey45", fill=NA, size=1), 
          panel.background = element_blank(), axis.title = element_blank(), 
...
DNA_types = function(dat = DougScaledPres, dna_dat=DNAdata){
  ...
  p3 = ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data = dat, aes(x=Long, y=Lat, col=factor(POP)), size=0.6, alpha=1) + 
...
Ecotypes = function(dat=DougScaledPres, cluster=useCluster, cols = NA){
  ...
  p4 = ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data = dat, aes(x=Long, y=Lat, col=factor(cluster)), size=0.2, alpha=1) + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) +
    ...
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
          ...
          axis.text = element_blank(), axis.ticks = element_blank(), legend.position = "bottom",
          legend.title = element_text(size=16, face="bold"),legend.text = element_text(size=14), 
          legend.key.size = unit(0.8, units = "cm"), legend.key = element_blank()) +
    guides(color = guide_legend(override.aes = list(size=4)))
 
  return(p4) 
}

coefficient_maps <- function(coefs, dat, round_to = 0){
  ...
  pTD <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.1)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  pTD2 <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.2)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  pPPT <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.3)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  pPPT2 <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.4)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  pMTWM <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.5)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  pMTWM2 <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.6)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  pIntercept <- ggplot() + 
    ...
    geom_path(data=ca_provinces,aes(x=long, y=lat, group=group), col="grey25")  + 
    geom_path(data=mex_states, aes(x=long, y=lat, group=group), col="grey25") +
    geom_point(data=dat, aes(x=Long, y=Lat, col=as.numeric(predTerms_cut.7)), size = 0.05)  + 
    coord_fixed(ratio=1, xlim = c(-130, -95), ylim=c(15, 55)) + 
  ...
  return(ggpubr::ggarrange(pMTWM, pTD, pPPT, pMTWM2, pTD2, pPPT2, pIntercept, 
                    ncol = 3, nrow = 3))
  
}


effectplots = function(df, nclusters){
  ...
  p = ggplot(df) + ylim(0,1) + geom_path(aes(x=newseq, y=median, col=as.factor(Cluster)),linewidth=1) + labs(y="Occurrence Probability")+
    geom_ribbon(aes(ymin =first, ymax = fourth, x=newseq), fill="grey50" , alpha=0.3) + 
    theme(aspect.ratio = 1, axis.title.x = element_blank(), 
          axis.text.x = element_text(size=11, angle = 45, vjust = 0.5, hjust=0.6),
          axis.text.y = element_text(size=11),
          strip.text.x = element_text(size=12, face="bold"),
          strip.text.y = element_text(size=12, face="bold"),panel.background = element_blank(), 
